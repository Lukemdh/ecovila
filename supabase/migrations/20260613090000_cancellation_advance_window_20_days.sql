-- Raise the public online cancellation advance window from 7 to 20 calendar days.
-- Policy unchanged otherwise:
-- - cash reservations are reimbursed only at the office, not cancelled online;
-- - online cancellation is available at least 20 calendar days before arrival
